...
public class FixtureController implements Serializable {
        ...
        public FixtureController(FloorView floorView, FloorModel floorModel, FloorController floorController,
                        FixtureModel fixtureModel, FixtureView fixtureView) {
        ...
        public void placeFixture(Point location) {
                ...
                if (fixtureModel.getOrientation() == Orientation.HORIZONTAL) {
                        ...
                        if (fixtureType == FixtureType.DOOR && (upRoomModel == null
                                        && (downRoomModel.getType() == RoomType.BEDROOM
                                                        || downRoomModel.getType() == RoomType.BATHROOM)
                        ...
                        if (fixtureType == FixtureType.DOOR &&
                                        ((leftRoomModel == null
                                                        && (rightRoomModel.getType() == RoomType.BEDROOM
                                                                        || rightRoomModel
                                                                                        .getType() == RoomType.BATHROOM))
                                                        || (rightRoomModel == null && (leftRoomModel
                                                                        .getType() == RoomType.BEDROOM
                        ...
                        if (fixtureModel.getOrientation() == Orientation.HORIZONTAL) {
                                ...
                                if (upRoomModel == null) {
                                        fixtureModel
                                                        ...
                                                        .setPreviewPosition(
                                                                        Tools.snap(new Point(
                                                                                        fixtureModel.getDownTilePosition().x
                                                                                                        + e.getPoint().x
                                                                                                        - room.getRoomModel()
                                                                                                                        .getPosition().x,
                                                                                        fixtureModel.getDownTilePosition().y
                                                                                                        + e.getPoint().y
                                                                                                        - room.getRoomModel()
                                                                                                                        .getPosition().y)));
                                        ...
                                        fixtureModel
                                                        ...
                                                        .setPreviewPosition(
                                                                        Tools.snap(new Point(
                                                                                        fixtureModel.getUpTilePosition().x
                                                                                                        + e.getPoint().x
                                                                                                        - room.getRoomModel()
                                                                                                                        .getPosition().x,
                                                                                        fixtureModel.getUpTilePosition().y
                                                                                                        + e.getPoint().y
                                                                                                        - room.getRoomModel()
                                                                                                                        .getPosition().y)));
                                } else {
                                ...
                                if (leftRoomModel == null) {
                                        fixtureModel
                                                        ...
                                                        .setPreviewPosition(
                                                                        Tools.snap(new Point(
                                                                                        fixtureModel.getRightTilePosition().x
                                                                                                        + e.getPoint().x
                                                                                                        - room.getRoomModel()
                                                                                                                        .getPosition().x,
                                                                                        fixtureModel.getRightTilePosition().y
                                                                                                        + e.getPoint().y
                                                                                                        - room.getRoomModel()
                                                                                                                        .getPosition().y)));
                                        ;
                                        ...
                                        fixtureModel
                                                        ...
                                                        .setPreviewPosition(
                                                                        Tools.snap(new Point(
                                                                                        fixtureModel.getLeftTilePosition().x
                                                                                                        + e.getPoint().x
                                                                                                        - room.getRoomModel()
                                                                                                                        .getPosition().x,
                                                                                        fixtureModel.getLeftTilePosition().y
                                                                                                        + e.getPoint().y
                                                                                                        - room.getRoomModel()
                                                                                                                        .getPosition().y)));
                                } else {
